...
class BankAccount extends \PagHiper\PagHiper
{
    ...
    {
        $accountsList = $this->paghiper->request(self::ACCOUNTS_ENDPOINT)['bank_account_list_request'];
    ...
    {
        $withdraw = $this->paghiper->request(self::CASHOUT_ENDPOINT, ['bank_account_id' => $bank_account_id])['cash_out_request'];
