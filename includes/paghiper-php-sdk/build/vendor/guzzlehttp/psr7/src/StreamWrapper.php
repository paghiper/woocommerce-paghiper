...
class StreamWrapper
{
     ...
     */
    public static function getResource(\PagHiperSDK\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\PagHiperSDK\Psr\Http\Message\StreamInterface $stream)
    {
