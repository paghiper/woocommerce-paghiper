 ...
 */
class FnStream implements \PagHiperSDK\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\PagHiperSDK\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
