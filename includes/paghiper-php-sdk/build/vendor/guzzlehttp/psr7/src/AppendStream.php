 ...
 */
class AppendStream implements \PagHiperSDK\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\PagHiperSDK\Psr\Http\Message\StreamInterface $stream)
    {
